...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIRECTORY, 'studyBuddy.db'), # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
   ...
   #('assets' , '/home/wiz/studybuddy/django/studybuddy/static'),
)
...
SECRET_KEY = 'hr2ma9r0er^%#lp^z9)vx@8*oz5b2)-wts69jdz$!&q6hwt0_g'
